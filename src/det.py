...
PILATUS_QRANGE = [0.10819808043306411 , 2.1592992310568926] #first non-zero to last non-zero
...
EIGER_QRANGE = [0.003050813179779477 , 0.3152601826718495] #first non-zero to last non-zero



DET_OVERLAP = [1.25e-1, 2.5e-1]
FULL_QRANGE = [EIGER_QRANGE[0], PILATUS_QRANGE[1]]


LINEAR_SAXS_RANGE = [0.005, 0.015]
